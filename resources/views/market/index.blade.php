...
@section('content')
    <div class="py-10">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <div class="hidden md:flex items-center gap-3">
                    <div class="p-3 bg-white rounded-xl shadow-sm border border-gray-200">
                        ...
                        <p class="text-lg font-semibold text-gray-900">{{ $cryptocurrencies->count() }}</p>
                    </div>
                    <div class="p-3 bg-white rounded-xl shadow-sm border border-gray-200">
                        <p class="text-xs text-gray-500">Top Volume 24H</p>
                        <p class="text-lg font-semibold text-gray-900">${{ number_format(optional($trending->first())->volume_24h ?? 0, 0, '.', ',') }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="card" x-data="marketTable(@js($cryptocurrencies->map(fn($crypto) => [
                'id' => $crypto->id,
